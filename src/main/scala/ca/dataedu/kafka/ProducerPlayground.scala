...
object ProducerPlayground extends App{
  ...
  registerProduct(Product(1, "Dragon Capsule", "Launch Vehicle", "$26000.00"), 35)
  registerProduct(Product(2, "Falcon 9 Rocket", "Launch Vehicle", "$62000000.00"), 5)
  registerProduct(Product(3, "Dream Chaser Cargo System", "System", "$40000.00"), 15)
  registerProduct(Product(4, "Biconic Farrier", "Rocket Part", "$999.95"), 100)
  registerProduct(Product(5, "Second-stage Fuselage", "Rocket Part", "$9800.00"), 100)
  registerProduct(Product(6, "Life Support Systems", "System", "$78653.34"), 20)
  registerProduct(Product(7, "Reaction Wheels", "Rocket Part", "$199.99"), 120)
  registerProduct(Product(8, "Air Jordans", "Misc.", "Priceless"), 1)
  registerProduct(Product(9, "Geosynchronous Satellite", "Satellite", "$68000.00"), 45)
  registerProduct(Product(10, "Docking Ports (x3)", "Rocket Part", "$2999.97"), 100)
  registerProduct(Product(11, "Space Junk", "Misc.", "$0.00"), 15)
  registerProduct(Product(12, "Mk2 Inline Cockpit", "Rocket Part", "$19999.99"), 85)
  registerProduct(Product(13, "RC-L01 Remote Guidance Unit", "System", "$424242.42"), 25)
  registerProduct(Product(14, "Rockomax Jumbo-64 Fuel Tank", "Rocket Part", "$1349.99"), 105)
  registerProduct(Product(15, "PB-X150 Xenon Container", "Rocket Part", "$200.00"), 80)
  registerProduct(Product(16, "FTX-2 External Fuel Duct", "Rocket Part", "$89.99"), 75)
  registerProduct(Product(17, "48-7S Liquid Fuel Engine", "Rocket Part", "$22313.43"), 25)
  registerProduct(Product(18, "Vernor Engine", "Rocket Part", "$9999.99"), 95)
  registerProduct(Product(19, "FL-A5 Adapter", "Rocket Part", "$800.00"), 115)
  registerProduct(Product(20, "Modular Girder Segment (x100)", "Rocket Part", "$9999.00"), 115)
  registerProduct(Product(21, "TT18-A Launch Stability Enhancer", "Rocket Part", "$50000.00"), 65)
  registerProduct(Product(22, "TT-70 Radial Decoupler", "Rocket Part", "$2000.00"), 90)
  registerProduct(Product(23, "Hydraulic Detachment Manifold", "Rocket Part", "$4500.00"), 25)
  registerProduct(Product(24, "Shock Cone Intake", "Rocket Part", "$1984.00"), 65)
  registerProduct(Product(25, "Advanced Nose Cone - Type B", "Rocket Part", "$6000.00"), 75)
  registerProduct(Product(26, "Small Delta Wing (x2)", "Rocket Part", "$1999.98"), 115)
  registerProduct(Product(27, "LY-01 Fixed Landing Gear", "Rocket Part", "$894.93"), 90)
  registerProduct(Product(28, "TR-2L Ruggedized Vehicular Wheel", "Rocket Part", "$478.99"), 70)
  registerProduct(Product(29, "Heat Shield (2.5m)", "Rocket Part", "$4000.00"), 85)
  registerProduct(Product(30, "Thermal Control System", "System", "$120000.00"), 25)
  registerProduct(Product(31, "OX-STAT Photovoltaic Panels", "Rocket Part", "$3.99"), 185)
  registerProduct(Product(32, "Fuel Cell Array", "Rocket Part", "$900.00"), 125)
  registerProduct(Product(33, "Z-200 Rechargeable Battery Bank", "Rocket Part", "$1037.00"), 70)
  registerProduct(Product(34, "HG-5 High Gain Antenna", "Rocket Part", "$137.00"), 105)
  registerProduct(Product(35, "2HOT Thermometer", "Rocket Part", "$0.99"), 120)
  registerProduct(Product(36, "Mystery Goo™ Containment Unit", "Rocket Part", "$1.99"), 45)
  registerProduct(Product(37, "SENTINEL Infrared Telescope", "Satellite", "$30000000.00"), 5)
  registerProduct(Product(38, "James Webb Space Telescope", "Satellite", "$9700000000.00"), 2)
  registerProduct(Product(39, "Low-Earth Satellite", "Satellite", "$1000000"), 15)
  registerProduct(Product(40, "Soyuz-2 Launch System", "Launch Vehicle", "$217000000.00"), 5)
  registerProduct(Product(41, "Atlast V Rocket", "Launch Vehicle", "$9800000"), 10)
  registerProduct(Product(42, "Polar Satellite Launch Vehicle", "Launch Vehicle", "$8740000.00"), 10)
  registerProduct(Product(43, "Northrop Grumman Pegasus", "Launch Vehicle", "$185000000.00"), 5)
  registerProduct(Product(44, "Saturn V", "Launch Vehicle", "$123456789.00"), 4)
  registerProduct(Product(45, "Sputnik 1", "Satellite", "$0.02"), 1)
